...
export const artworks: Artwork[] = [
  ...
  },
  {
    ...
    category: "Nature",
    image: artwork11,
    description: "A vibrant, circular painting of a sunset over a tropical landscape, featuring palm tree silhouettes against a fiery yellow and orange sky.",
    medium: "Acrylic on Fabric",
    size: "Circular, 12 inches"
  },
  {
    id: "12",
    title: "Couple Caricature (Traditional)",
    category: "Portraits",
    image: artwork12,
    description: "A fun caricature of a couple in traditional attire, rendered with watercolor and ink, highlighting the joyous expression of the subjects.",
    medium: "Watercolor and Ink",
    size: "A4"
  },
  {
    id: "13",
    title: "Denim Silhouette",
    category: "Abstract",
    image: artwork13,
    description: "A striking, faceless figure painted in black and gray tones onto a denim jacket, transforming clothing into wearable abstract art.",
    medium: "Acrylic on Denim",
    size: "Custom Jacket Piece"
  },
  {
    id: "14",
    title: "Childhood Gold",
    category: "Nature",
    image: artwork14,
    description: "A colorful watercolor scene depicting two children joyfully playing under a Golden Shower (Kani Konna) tree in a lush, rural setting.",
    medium: "Watercolor and Ink",
    size: "A4"
  },
  {
    ...
    category: "Concept Art",
    image: artwork15,
    description: "A symbolic drawing of a healthcare worker holding a medical shield and a large syringe, defending against stylized virus particles.",
    medium: "Watercolor and Ink",
    size: "A4"
  },
  {
    id: "16",
    title: "Sisters in Ink",
    category: "Portraits",
    image: artwork16,
    description: "A minimalist black and white ink sketch of two women sitting together, emphasizing their clothing texture and flowing hair with simple washes.",
    medium: "Ink Sketch",
    size: "A4"
  },
  {
    id: "17",
    title: "Flowing Profile",
    category: "Abstract",
    image: artwork17,
    description: "An abstract profile merged with flowing lines of green and blue, creating a vibrant, stylized representation of form and movement.",
  ...
  },
  {
    ...
    category: "Architecture",
    image: artwork18,
    description: "A detailed watercolor and ink sketch of a traditional Kerala temple gateway, focusing on the intricate red roof tiles and multi-tiered structure.",
    medium: "Watercolor and Ink Sketch",
    size: "A4"
  },
  {
    id: "19",
    title: "Wisdom Portrait",
    category: "Portraits",
    image: artwork19,
    description: "A warm watercolor portrait of an elderly woman in a traditional sari and glasses, captured with gentle color washes and a kind expression.",
    medium: "Watercolor",
    size: "A4"
  },
  {
    ...
    category: "Portraits",
    image: artwork20,
    description: "A highly detailed graphite pencil portrait of a young man and a younger girl embracing, capturing realistic texture and emotion.",
